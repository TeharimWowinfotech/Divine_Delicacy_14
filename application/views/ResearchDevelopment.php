                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="service-details__right">
                            ...
                            <span class="tagline">R&D Division </span>
                            <h3 class="service-details__title-1" style="color: #486d2a;"> Organic Fertilizer Pesticide &
                                PGR</h3>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="service-details__left">
                            ...
                            <div class="we-sell" style="    padding-top: 35px;">
                                <img src="<?php echo base_url() . 'assets/images/blog/testimonials-1.png '; ?>" alt=""
                                    class="img-fluid" style="border-radius: 70px 0px 70px 0px;">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="service-details__left">
                            ...
                            <div class="we-sell" style="padding-top:0px;">
                                <img src="<?php echo base_url() . './assets/images/about/R&d-1.jpg'; ?>" alt=""
                                    class="img-fluid">
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <h2 style="color:#486d2a;">Residual Testing Laboratory</h2>
                        <p>Krishidoot Analytical Laboratory Is One Of The Trusted Laboratory Serving Accurate Analysis
                            Of Soil, Water, <br>Petiole And Residual Analysis.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-6">
                        <div class="over">
                            <img src="<?php echo base_url() . './assets/images/about/About-3.png'; ?>" alt="Avatar" class="image img-fluid">
                            <div class="overlay">
                    ...
                    <div class="col-xl-6">
                    <div class="over">
                            <!-- <img src="<?php echo base_url() . './assets/images/about/R&d-1.jpg'; ?>" alt="Avatar" class="image">
                            <div class="overlay"> -->
                                <div class="text">Hello World</div>
                            </div>
                    </div>
